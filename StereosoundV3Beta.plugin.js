 ...
 * @source https://github.com/Umaroth8419/stereoAudio/blob/main/StereosoundV3Beta.plugin.js
 */
/*@cc_on
@if (@_jscript)
...
module.exports = (() => {
    const config = {"main":"index.js","info":{"name":"StereoAudioV3Beta","authors":[{"name":"Umaroth","discord_id":"798455664636198923","github_username":"Umaroth"}],"authorLink":"https://github.com/Umaroth8419","version":"1.0.1","description":"Modifies Audio Codec to enable 2 channel stereo. Requires either a stereo microphone setup, or an xlr microphone and interface. I personally reccomend using either Voicemeeter Potato, or ASIOLINKPRO.","github":"https://github.com/Umaroth8419/stereoAudio/blob/main/StereosoundV3Beta.plugin.js",},"changelog":[{"title":"Changes","items":["Wrote StereoAudio for BD Beta."]}],"defaultConfig":[{"type":"switch","id":"enableToasts","name":"Enable Toasts","note":"Allows the plugin to let you know it is working, and also warn you about voice settings","value":true}]};
  ...
  return class StereoSound extends Plugin {
    ...
    replacement(thisObj, _args, ret) {
      ...
      thisObj.conn.setTransportOptions = function (obj) {
		...
		//BITRATE
		{
		if (obj.encodingVoiceBitRate < 8000) { //128
